  ...
  return (
    <main>
      ...
      <section className="section eventsSection" id="events">
        <div className="sectionHeadingRow"><div><div className="sectionLabel light">05 · Events</div><h2>Upcoming platforms and selected past events.</h2></div><p className="lightText">Upcoming Events remains permanently available for new announcements, while completed conferences remain accessible as case studies.</p></div>
        <div className="eventGrid">
          <article className="eventCard upcomingCard"><div className="eventTopline"><span>Upcoming Events</span><span>Next</span></div><div className="upcomingBody"><span className="plus">+</span><h3>New scientific events will be announced here.</h3><p>Registration, programme, speaker, sponsor and venue information will be published as events are announced.</p><a className="textLink" href="/seroevents-website/events/upcoming/">View Upcoming Events →</a></div></article>
